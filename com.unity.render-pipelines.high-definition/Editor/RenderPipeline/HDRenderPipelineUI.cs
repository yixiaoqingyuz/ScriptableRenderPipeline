...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    static partial class HDRenderPipelineUI
    {
        ...
        static void Drawer_SectionShadows(SerializedHDRenderPipelineAsset serialized, Editor owner)
        {
            ...
            EditorGUILayout.PropertyField(serialized.renderPipelineSettings.supportVxShadows, k_SupportVxShadowsContents); //seongdae;vxsm
        ...
        static void SupportedSettingsInfoSection(SerializedHDRenderPipelineAsset serialized, Editor owner)
        {
            ...
            AppendSupport(builder, serialized.renderPipelineSettings.supportVxShadows, k_SupportVxShadowsContents); //seongdae;vxsm
