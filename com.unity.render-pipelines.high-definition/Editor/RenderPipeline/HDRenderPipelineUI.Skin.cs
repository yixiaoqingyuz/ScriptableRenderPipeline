...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    static partial class HDRenderPipelineUI
    {
        ...
        static readonly GUIContent k_SupportVxShadowsContent = EditorGUIUtility.TrTextContent("Vx Shadows", "When enabled, HDRP allocates memory for processing screen space vx shadow and needs dedicated ComputeBuffer during LightLoop. This allows you to use shadows for large scale and many lights in your Unity Projects."); //seongdae;vxsm
