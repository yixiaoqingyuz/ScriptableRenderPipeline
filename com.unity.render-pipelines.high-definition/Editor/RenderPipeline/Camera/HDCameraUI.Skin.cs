...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    static partial class HDCameraUI
    {
        ...
        static readonly GUIContent allowHWDynResContent = EditorGUIUtility.TrTextContent("Allow Hardware Dynamic Resolution", "Whether to support hardware dynamic resolution on supported platforms.");
