...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public sealed class PostProcessSystem
    {
        ...
        RenderTargetIdentifier[] m_TAAMRT;
        ...
        public PostProcessSystem(HDRenderPipelineAsset hdAsset)
        {
            ...
            m_TAAMRT = new RenderTargetIdentifier[2];
        ...
        void DoTemporalAntialiasing(CommandBuffer cmd, HDCamera camera, RTHandle source, RTHandle destination, RTHandle depthBuffer)
        {
            ...
            {
                m_TemporalAAMaterial.EnableKeyword("ORTHOGRAPHIC");
            }
            ...
            if (m_ResetHistory)
            {
                ...
                HDUtils.DrawFullScreen(cmd, camera, HDUtils.GetBlitMaterial(source.rt.dimension), prevHistory, m_TAAHistoryBlitPropertyBlock, 0);
                HDUtils.DrawFullScreen(cmd, camera, HDUtils.GetBlitMaterial(source.rt.dimension), nextHistory, m_TAAHistoryBlitPropertyBlock, 0);
            }
            ...
            m_TAAMRT[0] = destination;
            m_TAAMRT[1] = nextHistory;
            HDUtils.SetRenderTarget(cmd, camera, m_TAAMRT, depthBuffer);
            cmd.DrawProcedural(Matrix4x4.identity, m_TemporalAAMaterial, 0, MeshTopology.Triangles, 3, 1, null);
            cmd.DrawProcedural(Matrix4x4.identity, m_TemporalAAMaterial, 1, MeshTopology.Triangles, 3, 1, null);
        }
